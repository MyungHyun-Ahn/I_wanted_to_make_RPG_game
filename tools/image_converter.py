...
def boss_horizontal_slice(image_path, outdir, slice_size):
    ...
    for slice in range(slices):
        ...
        working_slice = img.crop(bbox)
        size = working_slice.size
        working_slice = working_slice.resize((240, 240))
        left += slice_size
...
boss_horizontal_slice("tools/boss/Hit.png", "tools/boss/attack", 50)
boss_horizontal_slice("tools/boss/Idle.png", "tools/boss/idle", 50)
boss_horizontal_slice("tools/boss/Walk.png", "tools/boss/move", 50)
