...
monster_data = {
	# normal
	'squid'           : {'health': 100,  'exp': 150, 'damage': 13,  'attack_type': 'slash',       'attack_sound': 'resource/audio/attack/slash.wav'   , 'speed': 2, 'resistance': 3, 'attack_radius': 80,  'notice_radius': 360},
	'spirit'          : {'health': 100,  'exp': 130, 'damage': 8,   'attack_type': 'thunder',     'attack_sound': 'resource/audio/attack/fireball.wav', 'speed': 3, 'resistance': 3, 'attack_radius': 60,  'notice_radius': 350},
	'bamboo'          : {'health': 70,   'exp': 120, 'damage': 6,   'attack_type': 'leaf_attack', 'attack_sound': 'resource/audio/attack/slash.wav'   , 'speed': 2, 'resistance': 3, 'attack_radius': 50,  'notice_radius': 300},
	'cyclope'         : {'health': 120,  'exp': 150, 'damage': 12,  'attack_type': 'rock',        'attack_sound': 'resource/audio/attack/rock.wav'   , 'speed': 3, 'resistance': 3, 'attack_radius': 50,  'notice_radius': 800},
	'greencyclope'    : {'health': 100,  'exp': 120, 'damage': 10,  'attack_type': 'rock',        'attack_sound': 'resource/audio/attack/rock.wav'   , 'speed': 3, 'resistance': 3, 'attack_radius': 50,  'notice_radius': 800},
	'bluebutterfly'   : {'health': 80,  'exp': 120,  'damage': 8,   'attack_type': 'smoke_orange', 'attack_sound': 'resource/audio/attack/frog.wav'   , 'speed': 2, 'resistance': 3, 'attack_radius': 50,  'notice_radius': 500},
	'minidragon'      : {'health': 110,  'exp': 140, 'damage': 10,  'attack_type': 'flam', 'attack_sound': 'resource/audio/attack/fire.wav'   , 'speed': 4, 'resistance': 3, 'attack_radius': 50,  'notice_radius': 600},
	'skull'           : {'health': 50,  'exp': 150, 'damage': 20,   'attack_type': 'cut', 'attack_sound': 'resource/audio/attack/claw.wav'   , 'speed': 5, 'resistance': 3, 'attack_radius': 40,  'notice_radius': 800},
...
normal_monster_name = ['squid', 'spirit', 'bamboo', 'cyclope', 'greencyclope', 'bluebutterfly', 'minidragon', 'skull']
boss_monster_name = ['raccoon', 'redraccoon', 'giantflam', 'frog', 'demoncyclope']